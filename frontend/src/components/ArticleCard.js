...
const ArticleCard = ({ className, post }) => {
  return (
    <div
      className={`rounded-xl shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] overflow-hidden ${className} hover:scale-105 transition-all`}
    >
